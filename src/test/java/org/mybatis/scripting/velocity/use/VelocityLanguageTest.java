...
import org.mybatis.scripting.velocity.VelocityTemplateEngine;
...
class VelocityLanguageTest {
  ...
  @AfterAll
  static void cleanup() {
    VelocityTemplateEngine.destroy();
  }
  ...
  void testAdditionalContextAttributes() {
    Object template = VelocityTemplateEngine.compile("SELECT * FROM users WHERE id = ${id}", "test");
    Map<String, Object> context = new HashMap<>();
    context.put("id", 123);
    String sql = VelocityTemplateEngine.apply(template, context);

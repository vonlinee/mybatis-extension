...
public class VelocityTemplateEngine {
  ...
  public static void initialize(VelocityLanguageDriverConfig driverConfig) {
    ...
    Set<Map.Entry<String, String>> entries = driverConfig.getAdditionalContextAttributes().entrySet();
    for (Map.Entry<String, String> entry : entries) {
      try {
        Object value = Resources.classForName(entry.getValue()).getConstructor().newInstance();
        additionalCtxAttributes.put(entry.getKey(), value);
      } catch (Exception e) {

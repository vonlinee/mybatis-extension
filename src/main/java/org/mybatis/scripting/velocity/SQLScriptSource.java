...
public class SQLScriptSource implements SqlSource {
  ...
  public SQLScriptSource(Configuration newConfiguration, String script, Class<?> parameterTypeClass) {
    ...
    this.compiledScript = VelocityTemplateEngine.compile(mappingParser.getSql(), "velocity-template-" + (++templateIndex));
  }
  ...
  public BoundSql getBoundSql(Object parameterObject) {
    ...
    final String sql = VelocityTemplateEngine.apply(this.compiledScript, context);
